...
#if defined(__linux__) || defined(__Fuchsia__) || defined(_WIN32_ITANIUM) || defined(__NTPOSIX__)
// Linux, Fuchsia, Windows Itanium, and NTPOSIX TLS support. Not yet an official part of the Itanium ABI.
