...
#if defined(__linux__) || defined(__Fuchsia__) || defined(_WIN32_ITANIUM)
// Linux, Fuchsia, and Windows Itanium TLS support. Not yet an official part of the Itanium ABI.
