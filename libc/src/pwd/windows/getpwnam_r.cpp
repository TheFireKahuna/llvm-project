//===-- Windows implementation of getpwnam_r ------------------------------===//
//
...
// POSIX getpwnam_r: reentrant version. Returns 0 on success or not-found
...
LLVM_LIBC_FUNCTION(int, getpwnam_r,
  ...
  *result = nullptr;
  int err = internal::fill_passwd_name(name, pwd, buf, buflen);
  if (err == ENOENT)
