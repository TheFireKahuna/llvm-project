...
//===----------------------------------------------------------------------===//
//
// POSIX syscall() entry point for compiler-rt and other internal consumers.
// Delegates to the existing syscall dispatch table which constant-folds the
// SYS_* number to a direct internal:: call at each call site.
//
//===----------------------------------------------------------------------===//
...
LLVM_LIBC_FUNCTION(long, __llvm_libc_syscall,
                   (long number, long arg1, long arg2, long arg3, long arg4,
                    long arg5, long arg6)) {
  long ret =
      LIBC_NAMESPACE::syscall_impl<long>(number, arg1, arg2, arg3, arg4, arg5,
                                         arg6);
