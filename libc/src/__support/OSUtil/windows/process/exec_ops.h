...
// Linux execveat (syscall 322): directory-fd-relative exec with
// AT_EMPTY_PATH and AT_SYMLINK_NOFOLLOW flag support. dirfd may be
// AT_FDCWD; pathname may be empty when AT_EMPTY_PATH is set.
// Returns -errno on failure. Does not return on success.
