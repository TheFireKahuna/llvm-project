...
__declspec(selectany) AppProperties app = {
...
int LIBC_NAMESPACE::internal::pcb_startup_init() {
  ...
  // Module identity: c.dll's own HINSTANCE (set by _DllMainCRTStartup
  // before __libc_dll_init()) and __dso_handle for __cxa_finalize.
  InitAccess::set_module_handle(__dso_handle);
