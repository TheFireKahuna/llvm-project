...
LIBC_MSABI __LIBC_EXTERN_DLLIMPORT_ATTR NTSTATUS RtlWaitOnAddress(
    volatile void *Address, void *CompareAddress, SIZE_T AddressSize,
    void *Timeout);
LIBC_MSABI __LIBC_EXTERN_DLLIMPORT_ATTR void RtlWakeAddressSingle(PVOID Address);
LIBC_MSABI __LIBC_EXTERN_DLLIMPORT_ATTR void RtlWakeAddressAll(PVOID Address);
} // extern "C"
