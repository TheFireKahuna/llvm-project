...
__declspec(dllimport) NTSTATUS NTAPI NtLockVirtualMemory(HANDLE ProcessHandle,
                                                         PVOID *BaseAddress,
                                                         SIZE_T *RegionSize,
                                                         ULONG MapType);
...
__declspec(dllimport) NTSTATUS NTAPI NtUnlockVirtualMemory(HANDLE ProcessHandle,
                                                           PVOID *BaseAddress,
                                                           SIZE_T *RegionSize,
                                                           ULONG MapType);
...
__declspec(dllimport) NTSTATUS NTAPI NtFreeVirtualMemory(HANDLE ProcessHandle,
                                                          PVOID *BaseAddress,
                                                          SIZE_T *RegionSize,
                                                          ULONG FreeType);
...
__declspec(dllimport) NTSTATUS NTAPI NtFlushProcessWriteBuffers(void);
...
__declspec(dllimport) NTSTATUS NTAPI NtUnmapViewOfSectionEx(HANDLE ProcessHandle,
                                                            PVOID BaseAddress,
                                                            ULONG Flags);
...
__declspec(dllimport) NTSTATUS NTAPI NtSetInformationVirtualMemory(
...
__declspec(dllimport) NTSTATUS NTAPI NtOpenPartition(HANDLE *PartitionHandle,
                                                     ULONG DesiredAccess,
...
__declspec(dllimport) NTSTATUS NTAPI NtExtendSection(HANDLE SectionHandle,
