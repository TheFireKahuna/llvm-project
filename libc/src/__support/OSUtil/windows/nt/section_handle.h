...
public:
  ...
  /// (typically by handing it to RegionPool::acquire_owned for table
  /// publication, or to a child process via spawn handle inheritance).
  ...
  [[nodiscard]] LIBC_INLINE static SectionHandle
  open_named(nt_wstring_view *name, ACCESS_MASK access,
             NTSTATUS *st = nullptr) {
