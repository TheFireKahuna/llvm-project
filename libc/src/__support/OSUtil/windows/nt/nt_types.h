...
// Function pointer — return type of GetProcAddress.
...
// Native APC callback used by NtQueueApcThread* entrypoints.
using PPS_APC_ROUTINE = void(NTAPI *)(PVOID ApcArgument1, PVOID ApcArgument2,
                                      PVOID ApcArgument3);
...
using PIO_APC_ROUTINE = void(NTAPI *)(PVOID ApcContext,
...
// DLL entry point callback — DllMain signature.
typedef BOOLEAN(NTAPI *PDLL_INIT_ROUTINE)(PVOID DllHandle, ULONG Reason,
                                          PVOID Context);
...
// TLS callback function pointer type.
