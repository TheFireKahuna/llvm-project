...
LIBC_MSABI void __activation_context_notify_type_source(
    ...
    PVOID NotificationContext, PVOID NotificationData,
    BOOLEAN *DisableThisNotification);
using PACTIVATION_CONTEXT_NOTIFY_ROUTINE =
    decltype(&__activation_context_notify_type_source);
...
using PPS_POST_PROCESS_INIT_ROUTINE =
    decltype(&__pps_post_process_init_type_source);
