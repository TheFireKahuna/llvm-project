...
// 3 pointers (24) + 7 ULONGs (28) = 52 bytes.
// Wake notification and owner TID have moved to ThreadRing::cq_word
// (ThreadLocalWord) — single-owner primitive with hardware address
// monitoring, replacing the old needs_wake tri-state + parking lot.
static_assert(sizeof(RingState) <= 56, "RingState layout changed");
