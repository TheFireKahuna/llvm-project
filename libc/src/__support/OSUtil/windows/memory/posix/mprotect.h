//===- mprotect.h - POSIX-layer mprotect declarations -----------*- C++ -*-===//
//
...
#define LLVM_LIBC_SRC___SUPPORT_OSUTIL_WINDOWS_MEMORY_POSIX_MPROTECT_H
...
#endif // LLVM_LIBC_SRC___SUPPORT_OSUTIL_WINDOWS_MEMORY_POSIX_MPROTECT_H
