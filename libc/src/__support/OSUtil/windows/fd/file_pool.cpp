...
LIBC_REGISTER_FINI(4, file_pool,
                   &::LIBC_NAMESPACE::internal::file_pool::destroy)

LIBC_REGISTER_FORK_REINIT(file_pool,
                          ::LIBC_NAMESPACE::internal::kForkPrioFilePool,
                          &::LIBC_NAMESPACE::internal::file_pool_fork_reinit)
