...
// context required to make it safely.
//
...
public:
  ...
  ///
  /// This is a simple MEM_RELEASE — neighbor-aware release lives at the
  /// munmap / vm_protect layer (release_if_isolated), which has the
  /// mapping-table context needed to make that decision safely.
