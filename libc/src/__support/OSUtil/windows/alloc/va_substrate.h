...
#include "src/__support/OSUtil/windows/alloc/substrate_registry.h"
...
// CrystallineNode words (next/slot/birth_epoch union, batch_link,
...
// real ArenaHeader* — that lets `g_substrate_domain.read(active_,
