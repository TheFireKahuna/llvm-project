...
LIBC_MSABI __LIBC_EXTERN_DLLIMPORT_ATTR NTSTATUS
...
LIBC_MSABI __LIBC_EXTERN_DLLIMPORT_ATTR void RtlAcquireSRWLockExclusive(SRWLOCK *);
LIBC_MSABI __LIBC_EXTERN_DLLIMPORT_ATTR void RtlReleaseSRWLockExclusive(SRWLOCK *);
} // extern "C"
