...
function(llvm_ExternalProject_Add name source_dir)
  ...
  if(NOT ARG_TOOLCHAIN_TOOLS)
    ...
    if(NOT _cmake_system_name STREQUAL "AIX")
      ...
      elseif(is_msvc_target OR is_itanium_target OR is_ntposix_target)
        list(APPEND ARG_TOOLCHAIN_TOOLS llvm-lib llvm-rc llvm-dlltool)
        ...
        # Windows Itanium needs resource and manifest tools.
        if(is_itanium_target OR is_ntposix_target)
          list(APPEND ARG_TOOLCHAIN_TOOLS llvm-rc)
          if(LLVM_ENABLE_LIBXML2)
            list(APPEND ARG_TOOLCHAIN_TOOLS llvm-mt)
          endif()
        endif()
  ...
  if(ARG_USE_TOOLCHAIN AND NOT CMAKE_CROSSCOMPILING)
    ...
    if(llvm-mt IN_LIST TOOLCHAIN_TOOLS AND (is_msvc_target OR is_itanium_target))
      list(APPEND compiler_args -DCMAKE_MT=${LLVM_RUNTIME_OUTPUT_INTDIR}/llvm-mt${CMAKE_EXECUTABLE_SUFFIX})
    endif()
    if(llvm-rc IN_LIST TOOLCHAIN_TOOLS AND (is_msvc_target OR is_itanium_target))
