...
function( get_host_triple var )
  # Windows Itanium; must precede MSVC check (SIMULATE_ID is empty).
  if(LLVM_HOST_TRIPLE MATCHES ".*-windows-itanium.*")
    if( CMAKE_SIZEOF_VOID_P EQUAL 8 )
      set( value "x86_64-unknown-windows-itanium" )
    else()
      set( value "i686-unknown-windows-itanium" )
    endif()
  ...
  elseif( CMAKE_SYSTEM_NAME STREQUAL "AIX" )
    ...
    if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Windows" AND NOT CYGWIN AND NOT MSYS AND NOT MINGW)
      # Fallback for native Windows when compiler isn't recognized as MSVC.
      ...
      elseif( CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL "x86" )
        ...
        message(WARNING "Unknown Windows host processor: ${CMAKE_HOST_SYSTEM_PROCESSOR}")
      endif()
    else()
