...
///   edge to 1. The \EstimatedTripCount is relative to the original loop entry,
///   but the branch weights are encoding the probabilities of the true/false
///   edges. The latter cannot validly be 0-0, because *if* the control flow
///   arrived here, one of the branches *must* be taken. Moreover,
